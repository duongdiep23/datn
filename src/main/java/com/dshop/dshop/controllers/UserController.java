...
public class UserController {
    ...
    public UserController(UserService userService, OrderDetailService orderDetailService, GetUserFromToken getUserFromToken, CategoryService categoryService, JwtUtils jwtUtils) {
