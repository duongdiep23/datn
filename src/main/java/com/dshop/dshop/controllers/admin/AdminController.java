...
import com.dshop.dshop.models.response.StatisticsResponse;
...
public class AdminController {
    ...
    public AdminController(GetUserFromToken getUserFromToken, StatisticsService statisticsService, Utilities utilities) {
...
//        Lấy dữ liệu biểu đồ (báo cáo 7 ngày gần nhất)
        ...
        List<Date> datesOfChart = utilities.getRecentDaysList(7);
